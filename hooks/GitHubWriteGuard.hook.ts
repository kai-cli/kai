...
async function main() {
  try {
    ...
    const reason = [
      ...
      ``,
      `2. After you approve, generate tokens for ALL approved commands:`,
      `   Single:  bun ${APPROVE_SCRIPT} "${shortCmd}" "<your response>"`,
      `   Batch:   bun ${APPROVE_SCRIPT} --batch "<your response>" "cmd1" "cmd2" "cmd3"`,
      ``,
