...
- **ALGORITHM** — for multi-step, complex work (load PAI/Algorithm/v3.12.0.md and follow it)
...
1. ALGORITHM mode requires Read tool to load PAI/Algorithm/v3.12.0.md — then follow that file exactly
