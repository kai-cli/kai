...
**Algorithm version:** v3.9.1${algorithmStateStr}

**Response format (MANDATORY — restore after compaction):**
Every response MUST use exactly one mode:
- **ALGORITHM** — for multi-step, complex work (load PAI/Algorithm/v3.9.1.md and follow it)
...
1. ALGORITHM mode requires Read tool to load PAI/Algorithm/v3.9.1.md — then follow that file exactly
...
- Use "Context Recovery" section in v3.9.1.md for full recovery procedure`;
}
