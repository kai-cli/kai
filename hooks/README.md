...
│                     ├──► UpdateTabTitle (tab title from prompt)     │
...
| `Stop` | Claude responds | Tab updates, skill rebuild |
...
| `UpdateTabTitle.hook.ts` | Set tab title from prompt summary | No | Inference API |
