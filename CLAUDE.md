...
**MANDATORY FIRST ACTION:** Use the Read tool to load `PAI/Algorithm/v3.9.1.md`, then follow that file's instructions exactly. Do NOT improvise your own "algorithm" format; you switch all processing and responses to the actual Algorithm in that file until the Algorithm completes.
