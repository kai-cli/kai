...
Distinct from TELOS/WISDOM.md (which is YourName's personal accumulated wisdom).
This tier is AI-maintained — William writes here when something worth keeping surfaces.
...
| PRODUCT/ | Product decisions, roadmap patterns, NPI lessons, customer insight extractions |
...
- When YourName explicitly asks to capture something
...
- **TELOS/WISDOM.md** — YourName's own wisdom, manually curated
