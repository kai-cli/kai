...
<img src="release-icon-v2.png" alt="KAI Releases" width="256">
...
This is the fastest way to get KAI running. Copy the directory, run the wizard, restart Claude Code.
...
Our first attempt at a general problem solver built into KAI to pursue Euphoric Surprise.
...
**Questions?** See the main [KAI README](../README.md).
