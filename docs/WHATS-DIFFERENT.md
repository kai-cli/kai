# What's Different: KAI 5.3.0 vs. Daniel Miessler's PAI

KAI is built on the foundation of Daniel Miessler's [PAI system](https://github.com/danielmiessler/Personal_AI_Infrastructure) — the Algorithm, TELOS framework, skill hierarchy, and hook lifecycle originated there. His work established the architecture for turning Claude Code into a personalized AI assistant.

KAI diverges with production hardening, multi-model debate/research, self-learning capabilities, and a domain-config build system. Here's what changed, what was added, and what you gain by deploying KAI 5.3.0.
...
|---|---|---|
| **Skills** | 63 (12 categories) | <!-- KAI:counts:skills:begin -->67<!-- KAI:counts:skills:end --> (streamlined, no dead skills) |
| **Hooks** | 21 | <!-- KAI:counts:hooks:begin -->54<!-- KAI:counts:hooks:end --> (all through stderr wrapper) |
...
All <!-- KAI:counts:hooks:begin -->54<!-- KAI:counts:hooks:end --> hooks now go through `run-hook.sh`, which:
