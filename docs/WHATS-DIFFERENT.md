...
| **Hooks** | 21 | <!-- KAI:counts:hooks:begin -->52<!-- KAI:counts:hooks:end --> (all through stderr wrapper) |
...
All <!-- KAI:counts:hooks:begin -->52<!-- KAI:counts:hooks:end --> hooks now go through `run-hook.sh`, which:
