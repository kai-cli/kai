...
| **Hooks** | 21 | <!-- KAI:counts:hooks:begin -->36<!-- KAI:counts:hooks:end --> (all through stderr wrapper) |
...
All <!-- KAI:counts:hooks:begin -->36<!-- KAI:counts:hooks:end --> hooks now go through `run-hook.sh`, which:
