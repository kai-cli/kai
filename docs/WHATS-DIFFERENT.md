...
|---|---|---|
| **Skills** | 63 (12 categories) | <!-- KAI:counts:skills:begin -->70<!-- KAI:counts:skills:end --> (streamlined, no dead skills) |
| **Hooks** | 21 | <!-- KAI:counts:hooks:begin -->59<!-- KAI:counts:hooks:end --> (all through stderr wrapper) |
...
All <!-- KAI:counts:hooks:begin -->59<!-- KAI:counts:hooks:end --> hooks now go through `run-hook.sh`, which:
