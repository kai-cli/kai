...
Current algorithm (v3.10.0) is spec-only — Claude reads it and follows it. Future: `algorithm.ts` could enforce phase transitions programmatically, validate ISC format before proceeding, and prevent phase-skipping at the execution level.
