...
| `hooks.jsonc` | <!-- KAI:counts:hooks:begin -->61<!-- KAI:counts:hooks:end --> lifecycle hooks (security, formatting, etc.) |
...
### Hooks (<!-- KAI:counts:hooks:begin -->61<!-- KAI:counts:hooks:end --> lifecycle events)
