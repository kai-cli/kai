...
| `hooks.jsonc` | <!-- KAI:counts:hooks:begin -->52<!-- KAI:counts:hooks:end --> lifecycle hooks (security, formatting, etc.) |
...
### Skills (<!-- KAI:counts:skills:begin -->86<!-- KAI:counts:skills:end --> modules)
...
### Hooks (<!-- KAI:counts:hooks:begin -->52<!-- KAI:counts:hooks:end --> lifecycle events)
