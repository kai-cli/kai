...
- [x] **Repo name:** `kai` (Kaizen AI)
- [x] **GitHub org/account:** `kai-cli` org, repo `kai-cli/kai`
- [ ] **Install URL:** final repo URL locks the `install.sh` content and all docs
- [x] **License:** MIT (single). Not dual — pick MIT and ship one `LICENSE` file consistently.
- [x] **Merge PR #2 (v4.8.0) to personal repo**
- [x] **Merge PR #3 (v4.9.0) to personal repo**
