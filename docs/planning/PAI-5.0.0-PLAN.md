...
| `OneOnOne/` | **Keep, fix "Deven"** | Generically useful EM skill — replace name with `{PRINCIPAL.NAME}` |
| `DecisionLog/` | **Keep, fix "Deven"** | Generically useful EM skill — replace name with `{PRINCIPAL.NAME}` |
