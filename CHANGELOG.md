...
- Manifest updated: <!-- KAI:counts:skills:begin -->87<!-- KAI:counts:skills:end --> skills, <!-- KAI:counts:hooks:begin -->56<!-- KAI:counts:hooks:end --> hooks, <!-- KAI:counts:agents:begin -->20<!-- KAI:counts:agents:end --> agents
- VERSION 5.2.0 → 5.6.0
...
- **<!-- KAI:counts:skills:begin -->87<!-- KAI:counts:skills:end --> skills** — Research, Security, Analysis, Writing, Engineering Manager workflows, and more
