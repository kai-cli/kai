...
- Manifest updated: <!-- KAI:counts:skills:begin -->85<!-- KAI:counts:skills:end --> skills, <!-- KAI:counts:hooks:begin -->52<!-- KAI:counts:hooks:end --> hooks, <!-- KAI:counts:agents:begin -->20<!-- KAI:counts:agents:end --> agents
- VERSION 5.2.0 → 5.6.0
