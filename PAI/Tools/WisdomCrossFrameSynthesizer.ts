...
const WISDOM_DIR = paiPath('MEMORY', 'WISDOM');
const FRAMES_DIR = paiPath('MEMORY', 'WISDOM', 'FRAMES');
const PRINCIPLES_DIR = paiPath('MEMORY', 'WISDOM', 'PRINCIPLES');
const META_DIR = paiPath('MEMORY', 'WISDOM', 'META');
