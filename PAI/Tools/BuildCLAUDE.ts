...
const SETTINGS_PATH = paiPath("settings.json");
const ALGORITHM_DIR = paiPath("PAI/Algorithm");
const LATEST_PATH = paiPath("PAI/Algorithm", "LATEST");
...
function loadVariables(): Record<string, string> {
  ...
  return {
    ...
    "{{PAI_VERSION}}": settings.pai?.version || "7.1.0",
