...
| QG7 | No abstracted numbers; all dangling-reference audits present when task involves removal/rename (Extended+) | Pin to specific values; add mandatory ISC criteria for dangling refs |
