...
- **PARALLELIZATION CHECK (MANDATORY for Extended+):** Before committing to an execution approach, identify independent workstreams:
  ...
  - Deciding parallelization during PLAN (not later in BUILD/EXECUTE) produces better execution strategies because the plan hasn't yet committed to sequential thinking.
