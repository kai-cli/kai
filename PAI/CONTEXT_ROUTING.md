...
| Product bugs / issues | `gh issue list --repo yourcompany/YourCompanyWRT` |
| FW dev tasks | `gh issue list --repo yourcompany/FWDEV` |
| Product management | `gh issue list --repo yourcompany/YourCompanyWRT` |
...
| YourCompanyWRT issues | `{MEM}Learning-YourCompany-Repo/memory/yourcompanywrt-issues.md` |
...
### TR-069-TR-369 (10 files — USP cert testing, Oktopus, Pinnacle)
...
| Personal Oktopus on AWS (35.161.158.31) | `{MEM}TR-069-TR-369/memory/reference_own_oktopus.md` |
| YourCompany team Oktopus (35.79.243.0) | `{MEM}TR-069-TR-369/memory/reference_cloud_oktopus.md` |
...
| **Oktopus setup + TLS + patches** | `~/Projects/TR-069_TR-369/handoff/OKTOPUS-SETUP-GUIDE.md` |
