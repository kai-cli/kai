---
name: Utilities
description: Developer utilities — CLI generation, skill scaffolding, delegation, upgrades, evals, documents, parsing, audio editing, Fabric patterns, Cloudflare, browser automation, and prompting. USE WHEN create CLI, build CLI, TypeScript CLI, create skill, scaffold skill, delegate, agent teams, upgrade, PAI upgrade, eval, benchmark, document, PDF, DOCX, XLSX, PPTX, parse, extract, YouTube, fabric, Cloudflare, worker, deploy, browser, screenshot, debug web, automate browser, meta-prompting, prompt engineering, clean audio, remove filler words.
---
