...
The System skill runs in the foreground so you can see all output, progress, and hear notifications as work happens. Documentation updates, integrity checks, and system operations are visible for transparency.
