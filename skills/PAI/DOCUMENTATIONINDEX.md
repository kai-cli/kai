...
When a skill is invoked, follow the SKILL.md instructions step-by-step: execute notifications, use the routing table to find the workflow, and follow the workflow instructions in order.
