...
| Directory | Contents |
|-----------|----------|
| `PAI/` | Core system: Algorithm v3.9.0, context routing, system docs |
...
Highlights: domain-based config, interactive installer, hook stderr wrapper + async flags, SecretScanner, GitHubWriteGuard, 18 named agents, Algorithm v3.9.0 with ISC quality gates, EM/PLM workflow skills, no personal data in repo.
