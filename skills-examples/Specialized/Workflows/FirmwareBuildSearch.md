...
Search Jenkins build artifacts, OpenWrt package feeds, and yourcompany-mcp build tools.
...
3. Cross-reference with `~/Projects/YourCompany-Wiki/` for known build issues
