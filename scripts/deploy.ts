...
| Skills | <!-- KAI:counts:skills:begin -->85<!-- KAI:counts:skills:end --> | Research, security, writing, analysis, etc. |
| Hooks | <!-- KAI:counts:hooks:begin -->52<!-- KAI:counts:hooks:end --> | Pre/post tool guards, format enforcement, etc. |
