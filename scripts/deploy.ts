...
| Skills | <!-- KAI:counts:skills:begin -->89<!-- KAI:counts:skills:end --> | Research, security, writing, analysis, etc. |
| Hooks | <!-- KAI:counts:hooks:begin -->56<!-- KAI:counts:hooks:end --> | Pre/post tool guards, format enforcement, etc. |
