...
| Skills | <!-- KAI:counts:skills:begin -->83<!-- KAI:counts:skills:end --> | Research, security, writing, analysis, etc. |
| Hooks | <!-- KAI:counts:hooks:begin -->47<!-- KAI:counts:hooks:end --> | Pre/post tool guards, format enforcement, etc. |
